...
if __name__ == '__main__':
    ...
    thisdf['value'] *= 100
    sns.boxplot(data=thisdf, x="disease", y="value", hue="scenario", palette=clist, ax=ax, showfliers=showfliers)
    ...
    ax = sns.boxplot(data=cs_df, hue="scenario", y="p_symp_care", palette=clist, ax=ax, showfliers=showfliers)
    ...
    thisdf['value'] *= 100
    ax = sns.boxplot(data=thisdf, x="disease", y="value", hue="scenario", palette=clist, ax=ax, showfliers=showfliers)
